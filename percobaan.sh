...
sleep 1
clear
echo $blue"              _____       _ _           _       _ _"
echo $blue"             | ____|_   _(_) |___ _ __ | | ___ (_) |_"
echo $blue"             |  _| \ \ / / | / __| '_ \| |/ _ \| | __|"
echo $blue"             | |___ \ V /| | \__ \ |_) | | (_) | | |_"
echo $blue"             |_____| \_/ |_|_|___/ .__/|_|\___/|_|\__|"
echo $blue"                                 |_|"
echo
echo $white"               --"$blue"||"$green"EvilSploit Advanced MPX7 frameWork"
echo $white"       ++**++**--"$blue"||"$white"Version :"$red"0.0.1"
echo $white"       ++**++**--"$blue"||"$white"Author  :"$red"Mr.MPX7"
echo $white"       ++**++**--"$blue"||"$white"Contack :"$red"Akhy Inginkan Ukhty"
echo $white"       ++**++**--"$blue"||"$white"Team    :"$red"Aceh Cyber Team"
echo $white"               --"$blue"||"$white"CodeName:"$red"Sucurity"
echo
echo $white"################################################"
echo $white"#             "$green"MENU VIP EVILSPLOIT              "$white"#"
echo $white"################################################"
echo $cyan"[01] LiteDDos untuk website" 
echo "[02] Lazymux" 
echo "[03] webdav" 
echo "[04] HackFb" 
...
if [ $pilihan = 00 ] || [ $pilihan = 0 ]
then
clear
echo $yellow"Terima kasih Telah Memakai Tools Saya"
sleep 3
echo $cyan" _____           _     __   __"
echo $red"|  ___|   _  ___| | __ \ \ / /__  _   _"
echo $purple"| |_ | | | |/ __| |/ /  \ V / _ \| | | |"
echo $cyan"|  _|| |_| | (__|   <    | | (_) | |_| |"
echo $red"|_|   \__,_|\___|_|\_\   |_|\___/ \__,_|"
sleep 1
clear
echo $white "Maafkan Saya My Friends"
fi
